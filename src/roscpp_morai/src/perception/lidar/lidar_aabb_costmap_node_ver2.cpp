...
string costmap_topic = "/costmap_from_lidar"; //OccupancyGrid publish topic

bool use_tf = true;                 // TF로 cloud를 costmap_frame으로 변환할지
bool require_tf = true;             // TF 실패하면 프레임 스킵할지
string costmap_frame = "base_link"; // costmap/marker publish frame // costmap 좌표가 차량 기준(로컬 좌표)
